...
for (int r = 0; r < ren; r++){
Console.WriteLine("La variable de " +  "Maria" + (r+1) + ": " + matriz[r,col-1]);
}
...
//IMPRESION GAUSS INCOGNITAS
for (int r = 0; r < ren; r++){
Console.WriteLine("La variable de " +  "ANABEL" + (r+1) + ": " + matriz2[r,col-1]);
}
...
Console.WriteLine("Estatura : " + t);
Console.WriteLine("Tiempo: " + yT);
...
Console.WriteLine("Raiz encontrada: [" + xMedia + "]");
